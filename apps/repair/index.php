...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark"><?php lang("Order list");?></h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="./"><?php lang("Home");?></a></li>
            <li class="breadcrumb-item active"><?php lang("Order list");?></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                  ...
                  <table class="table table-striped table-hover table-sm">
                    <thead>
                      <tr>
                        ...
                        <?php }?>
                        <th><?php lang("Date");?></th>
                        <th><?php lang("Topic");?></th>
                        <th><?php lang("Detail");?></th>
                        <th><?php lang("Operator");?></th>
                        <th><?php lang("responsible man");?></th>
...
foreach ($repair as $repair) {
    ...
    ?>
                      <tr>
                        ...
                        <td><?php echo $repair["inventory_id"]; ?></td></td>
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              ...
                              <small><a class="dropdown-item"
                                  ...
                                  <small><a target ="_blank"  class="dropdown-item"
                                  href=" apps/repair/report.php?id=<?php echo $repair["id"]; ?>"><i class="fas fa-edit"></i>
                                  <?php lang("Print");?></a></small>
